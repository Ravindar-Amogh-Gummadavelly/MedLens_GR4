...
export default function TopBar() {
  ...
  return (
    <header className="sticky top-0 z-30 h-14 bg-clinical-surface/90 backdrop-blur-md border-b border-clinical-border flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-3 relative">
        {/* Safety indicator */}
        <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-md bg-verified-bg border border-verified-border text-2xs font-semibold text-verified-text dark:bg-emerald-950/80 dark:border-emerald-800 dark:text-emerald-300">
